...
event OnPageReset(string page)
	...
	if(page == "Main")
		...
		AddToggleOptionST("playBookST","Speak Book Text", playBookVal)
		...
		AddKeyMapOptionST("entrySpeakKeyST", "Dial. Speak Key", entrySpeakKeyVal,flag)
...
state entrySpeakKeyST; KEYMAP
	...
	endEvent
	event OnHighlightST()
		SetInfoText("Pressing this key in dialogue will speak the current highlighted item.")
	endEvent
endState
...
Event OnKeyDown(Int KeyCode)
	if(KeyCode == entrySpeakKeyVal)
		if(lastMenuName == "Dialogue Menu")
			UI.Invoke("Dialogue Menu", "_root.DialogueMenu_mc.TTS_doSendTextForSpeech")
		elseIf(lastMenuName == "Book Menu")
			UI.Invoke("Book Menu", "_root.BookMenu_mc.TTS_SpeakPages")
		endIf
